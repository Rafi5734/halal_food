        ...
        <div className="w-full grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-3 lg:gap-3 md:gap-2 sm:gap-2">
          <div className="w-full mt-5 flex flex-col">
            <div className="mt-4 px-5 pb-5">
              ...
              <p className="mt-4 font-bold text-[#008f8f]">
                Jeckostyle is a qualityful business website for multi-products.
                It is 100% trust worthy website for yours desire products.
              </p>
            ...
            <div className="mt-4 px-5 pb-5">
              ...
              <div>
                <ul className="mt-3 font-bold">
                  <li className="border-b-[1px] text-[#008f8f] border-[#008f8f] pb-2 cursor-pointer hover:text-[#ffffff]">
                    Wishlist
                  </li>
          ...
          <div className="w-full relative mt-5 flex flex-col">
            <div className="mt-4 px-5 pb-5">
              <p className="font-bold border-b-4 border-[#008f8f] pb-2 text-nowrap text-[#008f8f]">
                LIKE ON US FACEBOOK
              </p>
              <div>
                <ul className="mt-3 font-bold">
                  <li className="text-[#008f8f] pb-2 cursor-pointer">
                    Coming Soon!
                  </li>
                </ul>
              </div>
