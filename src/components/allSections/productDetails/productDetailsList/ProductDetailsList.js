    ...
    return (
        <div className='container mb-10'>
            <div className='grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-3 lg:gap-3 md:gap-2 sm:gap2'>
                <div className="w-full relative mt-5 flex flex-col rounded-lg border border-gray-100 bg-white shadow-md">
                    <a className="relative mx-3 mt-3 flex h-70 rounded-xl" href="#">
                        <img className="rounded object-cover" src="https://i0.wp.com/halalfoodservicebd.com/wp-content/uploads/2022/12/gur-2.5-gk-Large.jpg?resize=400%2C400&ssl=1" alt="product image" />
                    ...
                    <div className="mt-4 px-5 pb-5">
                        ...
                        <div className="mt-2 mb-5 flex items-center justify-between">
                            <p>
                                ...
                                <span className="text-sm text-slate-900 line-through ms-3">$699</span>
                            </p>
